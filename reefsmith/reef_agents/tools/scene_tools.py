...
from reefsmith.agent_utils.room import RoomScene, SceneObject, UniqueID
...
from reefsmith.reef_agents.tools.snapping_helpers import (
    resolve_collision_if_penetrating,
    select_and_execute_snap_algorithm,
)
from reefsmith.utils.geometry_utils import (
    closest_point_on_aabb,
    compute_optimal_facing_yaw,
    ray_rectangle_intersection_2d,
)
from reefsmith.utils.shape_analysis import is_circular_object
