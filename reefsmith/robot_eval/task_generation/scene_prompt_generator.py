...
from reefsmith.prompts import RobotEvalPrompts, prompt_registry
from reefsmith.robot_eval.llm_utils import structured_llm_call
...
class ScenePromptGenerator:
    ...
    4. Outputs prompts compatible with reefsmith's CSV input format
    ...
    def write_prompts_csv(
        ...
        """Write prompts.csv for reefsmith consumption.

        Creates:
        - prompts.csv: Scene prompts in reefsmith CSV format
        ...
        # Write prompts.csv in reefsmith format.
