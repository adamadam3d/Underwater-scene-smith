...
from reefsmith.robot_eval.dmd_scene import DMDScene, load_scene_for_validation
from reefsmith.robot_eval.tools import create_state_tools, create_vision_tools
...
async def validate_task(
    ...
    Args:
        ...
        scene_state_path: Path to scene_state.json (object metadata from reefsmith).
