...
from reefsmith.agent_utils.base_stateful_agent import (
    BaseStatefulAgent,
    log_agent_usage,
)
from reefsmith.agent_utils.blender import BlenderServer
from reefsmith.agent_utils.clearance_zones import compute_openings_data
...
from reefsmith.agent_utils.rendering import save_directive_as_blend
...
class StatefulSeabedAgent(BaseStatefulAgent, BaseSeabedAgent):
    """Stateful floor plan agent using planner/designer/critic workflow.
    ...
    def __init__(
        ...
        """
        BaseSeabedAgent.__init__(self, cfg=cfg, logger=logger)
    ...
    def _add_wall_collision_with_openings(
        ...
        if not passable_openings:
            ...
            StatefulSeabedAgent._add_wall_collision(
