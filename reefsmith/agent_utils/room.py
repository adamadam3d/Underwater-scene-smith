...
from reefsmith.utils.geometry_utils import compute_aabb_corners, safe_convex_hull_2d
...
def extract_and_propagate_support_surfaces(
    ...
    if (
        ...
        from reefsmith.agent_utils.hssd_retrieval.support_surface_loader import (
