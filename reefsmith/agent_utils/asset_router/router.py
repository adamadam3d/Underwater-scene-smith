...
from reefsmith.agent_utils.articulated_retrieval_server.dataclasses import (
    ArticulatedRetrievalResult,
)
from reefsmith.agent_utils.asset_router.dataclasses import (
    AnalysisResult,
    ArticulatedGeometry,
    AssetItem,
    GeneratedGeometry,
...
from reefsmith.agent_utils.blender.renderer import MATERIAL_VALIDATION_LIGHT_ENERGY
...
from reefsmith.agent_utils.materials_retrieval_server import (
    MaterialsRetrievalServerRequest,
)
from reefsmith.agent_utils.objaverse_retrieval_server.dataclasses import (
    ObjaverseRetrievalServerRequest,
)
from reefsmith.agent_utils.room import AgentType, ObjectType
from reefsmith.agent_utils.thin_covering_generator import (
...
from reefsmith.prompts import AssetRouterPrompts, prompt_manager
from reefsmith.utils.openai import encode_image_to_base64
...
if TYPE_CHECKING:
    ...
    from reefsmith.agent_utils.hssd_retrieval_server import HssdRetrievalClient
    from reefsmith.agent_utils.hssd_retrieval_server.dataclasses import (
        HssdRetrievalResult,
    )
    from reefsmith.agent_utils.image_generation import BaseImageGenerator
    from reefsmith.agent_utils.materials_retrieval_server import (
        MaterialsRetrievalClient,
    )
    from reefsmith.agent_utils.objaverse_retrieval_server import (
...
class AssetRouter:
    ...
    def _render_mesh_for_validation(
        ...
        from reefsmith.agent_utils.blender.renderer import ARTICULATED_LIGHT_ENERGY
