...
Usage:
    python -m reefsmith.agent_utils.materials_retrieval_server.standalone_server
    python -m reefsmith.agent_utils.materials_retrieval_server.standalone_server --port 7018
    python -m reefsmith.agent_utils.materials_retrieval_server.standalone_server --no-preload
"""
...
def main() -> int:
    ...
    try:
        ...
        if args.materials_path or args.embeddings_path:
            ...
            from reefsmith.agent_utils.materials_retrieval_server.config import (
                MaterialsConfig,
            )
