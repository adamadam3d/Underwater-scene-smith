"""SceneEval format exporter for reefsmith scenes."""
...
if TYPE_CHECKING:
    from reefsmith.agent_utils.house import HouseLayout, HouseScene, Opening, Wall
...
class SceneEvalExporter:
    ...
    - Coordinate system: Z-up, Y-forward (matches both reefsmith and SceneEval)
    """
    ...
    def _build_scene_state(self) -> dict:
        ...
        return {
            ...
            "scene": {
                ...
                "id": f"reefsmith-{self.scene_dir.name}",
                "unit": 1.0,
                "up": [0, 0, 1],
                "front": [0, 1, 0],
    ...
    def _opening_to_hole(self, opening: Opening, wall_height: float) -> dict | None:
        ...
        """
        from reefsmith.agent_utils.house import OpeningType
    ...
    def _get_open_room_pairs(self) -> list[list[str]]:
        ...
        from reefsmith.agent_utils.house import ConnectionType
    ...
    def export_house(
        ...
        scene_state = {
            ...
            "scene": {
                "version": SCENEEVAL_VERSION,
                "id": f"reefsmith-{output_dir.name}",
                "unit": 1.0,
                "up": [0, 0, 1],
                "front": [0, 1, 0],
