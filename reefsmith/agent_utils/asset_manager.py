...
from reefsmith.agent_utils.convex_decomposition_server import ConvexDecompositionClient
...
from reefsmith.agent_utils.materials_retrieval_server import MaterialsRetrievalClient
...
from reefsmith.agent_utils.objaverse_retrieval_server import ObjaverseRetrievalClient
from reefsmith.agent_utils.objaverse_retrieval_server.dataclasses import (
    ObjaverseRetrievalServerRequest,
)
from reefsmith.agent_utils.room import AgentType, ObjectType, SceneObject, UniqueID
    ...
    def _retrieve_hssd_assets(
        ...
        for index, response in self.hssd_client.retrieve_objects(retrieval_requests):
            ...
            try:
                ...
                # Canonicalize mesh orientation to align with reefsmith canonical
