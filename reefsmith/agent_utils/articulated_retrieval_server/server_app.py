...
from reefsmith.agent_utils.articulated_retrieval_server.config import ArticulatedConfig
from reefsmith.agent_utils.articulated_retrieval_server.retrieval import (
    ArticulatedRetriever,
)
from reefsmith.agent_utils.scheduler import QueuedRequest, StrictRoundRobinScheduler
    ...
    def _get_retriever(self) -> ArticulatedRetriever:
        ...
        if self._retriever is None:
            ...
            if config is None:
                ...
                from reefsmith.agent_utils.articulated_retrieval_server.config import (
