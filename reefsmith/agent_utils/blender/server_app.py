...
from reefsmith.agent_utils.blender.canonicalization import canonicalize_mesh_impl
from reefsmith.agent_utils.blender.mesh_conversion import convert_glb_to_gltf_impl
from reefsmith.agent_utils.blender.params import RenderParams
from reefsmith.agent_utils.blender.renderer import BlenderRenderer
...
class BlenderRenderApp(flask.Flask):
    ...
    def __init__(
        ...
        """
        super().__init__("reefsmith_blender_render")
