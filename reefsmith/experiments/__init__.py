...
from .underwater_scene_generation import UnderwaterSceneGenerationExperiment

# Each key has to be a yaml file under '[project_root]/configurations/experiment'
# without .yaml suffix.
exp_registry = dict(underwater_scene_generation=UnderwaterSceneGenerationExperiment)
