...
from reefsmith.agent_utils.scene_analyzer import FurnitureSelection, SceneAnalyzer
...
from reefsmith.prompts.registry import ManipulandAgentPrompts
from reefsmith.utils.logging import BaseLogger

console_logger = logging.getLogger(__name__)


class StatefulMicroHabitatAgent(BaseStatefulAgent, BaseMicroHabitatAgent):
    ...
    def __init__(
        ...
        BaseMicroHabitatAgent.__init__(
            self,
            cfg=cfg,
            logger=logger,
            geometry_server_host=geometry_server_host,
